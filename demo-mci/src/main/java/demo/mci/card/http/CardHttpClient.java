...
public class CardHttpClient {
    ...
    public CardHttpClient(String host, int port) {
        // 레이아웃 등록
    ...
    public void connect() {
        client.connect();
        log.info("Card HTTP client initialized");
    }
    ...
    public void disconnect() {
        client.disconnect();
        log.info("Card HTTP client disconnected");
    }
    ...
    public static void main(String[] args) {
        ...
        CardHttpClient cardClient = new CardHttpClient(host, port);
