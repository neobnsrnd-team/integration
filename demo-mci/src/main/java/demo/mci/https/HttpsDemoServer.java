...
public class HttpsDemoServer {
    ...
    public HttpsDemoServer(int port) {
        this(port, null, null);
    }

    public HttpsDemoServer(int port, String keyStorePath, String keyStorePassword) {
        // 레이아웃 등록
    ...
    public void start() {
        server.start();
        log.info("Demo HTTPS Server started on port {}", server.getConfig().getPort());
    ...
    public void stop() {
        ...
        log.info("Demo HTTPS Server stopped");
    }
    ...
    public static void main(String[] args) {
        ...
        HttpsDemoServer demoServer = new HttpsDemoServer(port, keyStorePath, keyStorePassword);
        demoServer.start();
