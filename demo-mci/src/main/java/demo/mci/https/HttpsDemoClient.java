...
public class HttpsDemoClient {
     ...
     */
    public HttpsDemoClient(String host, int port) {
        this(host, port, true);
    }
     ...
     */
    public HttpsDemoClient(String host, int port, boolean trustAll) {
        // 레이아웃 등록
    ...
    public void connect() {
        client.connect();
        log.info("HTTPS client initialized");
    }
    ...
    public void disconnect() {
        client.disconnect();
        log.info("HTTPS client disconnected");
    }
    ...
    public static void main(String[] args) {
        ...
        HttpsDemoClient demoClient = new HttpsDemoClient(host, port);
