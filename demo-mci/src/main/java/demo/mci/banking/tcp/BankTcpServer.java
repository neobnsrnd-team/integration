...
public class BankTcpServer {
    ...
    public void start() {
        server.start();
        log.info("Bank TCP Server started on port {}", server.getConfig().getPort());
    }
    ...
    public void stop() {
        server.stop();
        log.info("Bank TCP Server stopped");
    }
    ...
    public static void main(String[] args) {
        ...
        BankTcpServer demoServer = new BankTcpServer(port);
        demoServer.start();
