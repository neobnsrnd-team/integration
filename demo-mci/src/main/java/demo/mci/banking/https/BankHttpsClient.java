...
public class BankHttpsClient {
     ...
     */
    public BankHttpsClient(String host, int port) {
        this(host, port, true);
    }
     ...
     */
    public BankHttpsClient(String host, int port, boolean trustAll) {
        // 레이아웃 등록
    ...
    public void connect() {
        client.connect();
        log.info("Bank HTTPS client initialized");
    }
    ...
    public void disconnect() {
        client.disconnect();
        log.info("Bank HTTPS client disconnected");
    }
    ...
    public static void main(String[] args) {
        ...
        BankHttpsClient demoClient = new BankHttpsClient(host, port);
        ...
        try {
            ...
            // 에코 테스트
            demoClient.echo("Hello, HTTPS MCI!");
