...
public class BankHttpClient {
    ...
    public BankHttpClient(String host, int port) {
        // 레이아웃 등록
    ...
    public void connect() {
        client.connect();
        log.info("Bank HTTP client initialized");
    }
    ...
    public void disconnect() {
        client.disconnect();
        log.info("Bank HTTP client disconnected");
    }
    ...
    public static void main(String[] args) {
        ...
        BankHttpClient demoClient = new BankHttpClient(host, port);
